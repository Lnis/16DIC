...
import arrayDeObjetos.Persona;

public class PrincipalPersona extends JFrame {
	
	public PrincipalPersona() {
//		JFrame miVentana = new JFrame();
		setTitle ("Base de Datos de Personal"); //le ponemos título a nuestra ventana
//		JTextPane miCampoDeTexto = new JTextPane();
//		miCampoDeTexto.setText("BIENVENIDO");	
//		miVentana.add(miCampoDeTexto);
		setLayout(new FlowLayout(FlowLayout.LEFT, 10, 20));
			add(new JButton("* INSERTAR PERSONA"));
			add(new JButton("* LISTAR PERSONAS"));
			add(new JButton("* BUSCAR PERSONA POR NOMBRE "));
	...
	public static void main(String[] args) {
		...
		PrincipalPersona aplicacion = new PrincipalPersona();
