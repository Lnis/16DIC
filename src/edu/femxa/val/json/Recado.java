...
public class Recado implements Comparable<Recado> {
	...
	public int compareTo(Recado reca){
		/**
		 * SI THIS ES MAYOR QUE RECA
		 * DEVUELVE UN NUMERO POSITIVO,
		 * SI THIS ES MENOR QUE RECA,
		 * DEVUELVE UN NUMERO NEGATIVO
		 * SINO DEVUELVE 0, ENTONCES ES QUE NO SON IGUALES
		 */
		String t1=this.getTelefono();
		String t2=reca.telefono;
	...
	public String toString() {
		...
		str_recado = this.getNombre_cliente() + "";
		return str_recado;
